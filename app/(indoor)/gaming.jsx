    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Indoor', subcategoryName: 'gaming' },
        });
      }, 2000);
    }
  }, [isMember]);
 ...
 const sendRequestToAdmin = async () => {
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.indoor.gaming,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          For casual players, hardcore gamers, and everyone in between. Talk strategy, share game recommendations, and connect over your favorite titles — from console classics to mobile hits and everything in between.
        </Text>
        </ScrollView>
