...
const Movies = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Indoor', subcategoryName: 'movie' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.indoor.movies,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Lights, camera, conversation! This is the place for movie lovers to talk films, reviews, behind-the-scenes trivia, and all things cinema — whether you are into indie films, blockbusters, or cult classics.
        </Text>
        </ScrollView>
