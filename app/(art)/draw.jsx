...
const Draw = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Art', subcategoryName: 'draw' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.art.draw,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Sketch, doodle, or illustrate — this group is your creative canvas. Share your artwork, explore styles, exchange tips, and inspire each other through the power of drawing. Beginners and pros welcome!
        </Text>
        </ScrollView>
