...
const Writing = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Art', subcategoryName: 'writing' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.art.writing, 
    ...
    >
      ...
      <Text
        ...
        numberOfLines={25}
      >
       A space for storytellers, poets, and writers of all kinds. Share your work, exchange feedback, find inspiration, or simply connect with others who love the written word. Let your creativity flow, one word at a time.
      </Text>
      </ScrollView>
