...
const Photo = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Art', subcategoryName: 'photo' },        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.art.photo, 
...
<View
    ...
    >
      ...
      <Text
        ...
        numberOfLines={25}
      >
        Capture the world through your lens. This group is for anyone passionate about photography — from mobile snapshots to DSLR art. Share your shots, learn new techniques, and see how others view the world around them.
      </Text>
      </ScrollView>
