...
const SportsForum = () => {
  ...
  const { groupName, subcategoryName, locationLat, locationLong } = route.params;
  ...
  const handleChatButtonPress = () => {
    if (!location) {
      Alert.alert('Error', 'Location is required to access the chat.');
      return;
    }

    router.push({
      pathname: '/(memberArt)/MemberArtLocation',
      params: {
        groupName: groupName, // Transmitem groupName
        subcategoryName: subcategoryName, // Transmitem subcategoryName
      },
    });
  };
