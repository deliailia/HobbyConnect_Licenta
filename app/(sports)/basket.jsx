...
const Basket = () => {
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.sport.basket,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={20}
        >
          Want to improve your basketball IQ or skills? Ask questions, share techniques, and get inspired by others who love the game.
        </Text>
        </ScrollView>
