...
const Volley = () => {
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.sport.volley,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Here to improve your volleyball game? Discuss training routines, learn positions, and share videos or advice with a community of passionate players.
        </Text>
        </ScrollView>
