...
const Pilates = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Sport', subcategoryName: 'pilates' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.sport.pilates,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={35}
        >
          New to Pilates? No worries! This group is perfect for learning the basics, understanding breathing techniques, and building core strength with guidance and encouragement.
        </Text>
        </ScrollView>
