...
const Soccer = () => {
  ...
  const checkMembership = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.error('Erorr checking member', data.message);
      }
    } catch (error) {
      console.error('Erorr checking member', error);
    }
  };
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.sport.soccer,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={20}
        >
          Looking to play or improve your soccer skills? Join us to share drills, training tips, match discussions, and maybe find teammates near you!
        </Text>
        </ScrollView>
        ...
        {location ? (
          ...
          <Text style={{ fontSize: 18, color: '#ff0000', marginTop: 20 }}>
          </Text>
        )}
