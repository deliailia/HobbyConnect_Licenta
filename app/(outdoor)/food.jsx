...
useEffect(() => {
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.outdoor.food,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Calling all foodies! This group is for those who love discovering new flavors, dishes, and cuisines. Share tasting experiences, restaurant recommendations, and your latest culinary adventures. Lets eat our way around the world!
        </Text>
        </ScrollView>
