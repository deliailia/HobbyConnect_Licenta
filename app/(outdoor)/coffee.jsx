...
const Coffee = () => {
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.outdoor.coffee,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          “Welcome to the Coffee Tasting group — where every cup tells a story. Share your favorite brews, explore beans from around the world, and connect with fellow caffeine lovers. From espresso to pour-over, this is your cozy coffee corner.
        </Text>
        </ScrollView>
