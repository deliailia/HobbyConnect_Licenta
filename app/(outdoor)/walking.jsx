...
useEffect(() => {
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.outdoor.walking,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Step into wellness! This group is for people who enjoy walking—whether its for fitness, fun, or mindfulness. Share routes, set goals, or simply connect with others who love putting one foot in front of the other.
        </Text>
        </ScrollView>
