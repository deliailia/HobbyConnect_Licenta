...
const Travelling = () => {
  ...
  const subcategoryName = 'travelling'; 
...
useEffect(() => {
  if (isMember) {
    setTimeout(() => {
      router.push({
        pathname: '/(forums)/OutdoorsForum',
        params: {
          groupName: 'Outdoor',
          subcategoryName: 'travelling',
        },
      });
    }, 2000);
  }
  ...
  return (
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.outdoor.travelling,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Wanderlust starts here! Whether you are planning your next trip or reminiscing about past adventures, this group is your place to share travel tips, stories, and destinations worth exploring. Lets inspire each other to see the world.
        </Text>
        </ScrollView>
