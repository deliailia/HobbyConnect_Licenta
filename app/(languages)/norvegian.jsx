...
const Norvegian = () => {
  ...
  const subcategoryName = 'norvegian'; 
  ...
  const checkMembership = async () => {
    try {
      ...
      console.log('Checking membership at URL:', url);
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Language', subcategoryName: 'norvegian' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.languages.norvegian,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
         Learning Norwegian for travel, heritage, or fun? Here you can ask questions, share cool facts about Norway, and improve your language skills with friendly learners like you!
        </Text>
        </ScrollView>
