...
const Italian = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Language', subcategoryName: 'italian' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.languages.italian,
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          Benvenuti! This group is for anyone interested in learning Italian—whether you're a beginner or already fluent. Share grammar tips, vocabulary, and cultural insights. Lets bring la dolce lingua to life together!
        </Text>
        </ScrollView>
