...
const French = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Language', subcategoryName: 'french' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.languages.french, 
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={15}
        >
          A group dedicated to French language enthusiasts who want to improve their communication skills, vocabulary, and grammar. Join us for discussions, exercises, and cultural exchange in a friendly and supportive environment.
        </Text>
