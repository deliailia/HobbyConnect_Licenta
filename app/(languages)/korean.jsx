...
const Korean = () => {
    ...
    if (isMember) {
      setTimeout(() => {
        router.push({
          ...
          params: { groupName: 'Language', subcategoryName: 'korean' },
        });
      }, 2000);
    }
  }, [isMember]);
  ...
  return (
    ...
    <View
      style={{
        flex: 1,
        backgroundColor: Colors.languages.korean, 
    ...
    >
      ...
      >
        ...
        <Text
          ...
          numberOfLines={25}
        >
          If you love K-pop, K-dramas, or Korean culture and want to understand the language behind it—this is the group for you! Share what you love and learn some Korean along the way.
        </Text>
        </ScrollView>
